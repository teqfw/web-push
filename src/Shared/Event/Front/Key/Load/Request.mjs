...
export default class TeqFw_Web_Push_Shared_Event_Front_Key_Load_Request {
    ...
    constructor(
        ...
        // INSTANCE METHODS
        /**
         * @param {{data: TeqFw_Web_Push_Shared_Event_Front_Key_Load_Request.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}} [data]
         * @return {{data: TeqFw_Web_Push_Shared_Event_Front_Key_Load_Request.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}}
         */
