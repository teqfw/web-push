...
export default class TeqFw_Web_Push_Shared_Event_Front_Subscript_Save_Request {
    constructor(spec) {
        ...
        // INSTANCE METHODS
        /**
         * @param {{data: TeqFw_Web_Push_Shared_Event_Front_Subscript_Save_Request.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}} [data]
         * @return {{data: TeqFw_Web_Push_Shared_Event_Front_Subscript_Save_Request.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}}
         */
